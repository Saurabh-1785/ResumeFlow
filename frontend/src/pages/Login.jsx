...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(from, { state: { templateId } });
        } catch (err) {
            setError(err);
        }
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-stone-50 dark:bg-gray-900 p-4">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-200 dark:border-gray-700">
                <h2 className="text-3xl font-bold text-center mb-6 text-yellow-800 dark:text-yellow-500">Welcome Back</h2>
                ...
                <p className="mt-6 text-center text-gray-600 dark:text-gray-400">
                    ...
                    <Link to="/register" className="text-yellow-800 dark:text-yellow-500 hover:underline font-semibold">
                        Register
                    </Link>
                </p>
            </div>
