...
function SectionOrder({ sectionOrder, setSectionOrder, onSaveChanges, isUpdating }) {
  ...
  return (
    <div className="border md:border-r-20 rounded-bl-4xl p-10 mt-0 w-full max-w-3xl border-yellow-600">
      <h2 className="text-[clamp(25px,4vw,60px)] text-center font-lobster mb-20 p-4 text-yellow-600">Section Order</h2>
        ...
        {sectionOrder.map((section, index) => (
          <div key={section.id} className="flex items-center gap-4 p-4 bg-stone-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <input
              ...
              className="w-5 h-5 text-yellow-600 bg-stone-50 border-gray-300 rounded focus:ring-yellow-500 dark:focus:ring-yellow-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            ...
            <button
              ...
              disabled={index === 0}
              className="p-2 rounded-md bg-yellow-600 text-stone-50 hover:bg-yellow-700 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors"
              aria-label="Move up"
            >
      ...
      <div className="space-y-3">
        <button 
          ...
          className="w-full cursor-pointer transition-all ease-in duration-300 text-yellow-600 bg-stone-50 border border-yellow-600 font-bold px-4 py-3 rounded-2xl hover:bg-yellow-600 hover:text-stone-50"
        >
