...
function SectionOrder({ sectionOrder, setSectionOrder, onSaveChanges, isUpdating }) {
  ...
  return (
    <div className="border md:border-r-20 rounded-bl-4xl p-10 mt-0 w-full max-w-3xl border-yellow-800 dark:border-yellow-600">
      <h2 className="text-[clamp(35px,6vw,55px)] text-center font-sans font-bold mb-20 p-4 text-yellow-800 dark:text-yellow-600">Order Sections</h2>
          ...
          <div key={section.id} className="flex items-center gap-4 p-4 bg-stone-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <label className="flex items-center gap-4 flex-1 cursor-pointer">
              ...
              <input
                ...
                className="w-5 h-5 cursor-pointer text-yellow-800 bg-stone-50 border-gray-300 rounded dark:text-yellow-600  dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              />
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full transition-all ease-in duration-300 text-yellow-800 bg-stone-50 border border-yellow-800 font-bold px-4 py-3 rounded-2xl dark:text-yellow-600 dark:border-yellow-600"
        >
        ...
        {onSaveChanges && (
          <button
            ...
            disabled={isUpdating}
            className="w-full transition-all ease-in duration-300 text-stone-50 bg-yellow-800 font-bold px-4 py-3 rounded-2xl hover:bg-yellow-700 disabled:bg-gray-400 dark:bg-yellow-600"
          >
