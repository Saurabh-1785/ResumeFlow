  ...
  return (
      <div className="border border-r-20 rounded-bl-4xl p-10 mt-0 w-full max-w-3xl border-yellow-600">
        ...
        <div className="flex justify-between mt-3 mb-5">
          <button onClick={() => setStep(3)} className="text-white cursor-pointer bg-yellow-600 font-bold px-10 py-2 rounded-3xl border text-xl">Previous</button>
          <button onClick={() => setStep(5)} className="text-white cursor-pointer bg-yellow-600 font-bold px-10 py-2 rounded-3xl border text-xl">Enhance</button>
        </div>
      </div>
  );
}
