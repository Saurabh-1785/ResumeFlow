function Experience({ data, setData, setStep, onSaveChanges, isUpdating, enhancingId, onEnhance }) {
  ...
  return (
    <div className="border md:border-r-20 rounded-bl-4xl p-10 mt-0 w-full max-w-3xl border-yellow-800 dark:border-yellow-600">
      ...
      <button onClick={addExperience} className="inline cursor-pointer text-yellow-800 border-yellow-800 dark:text-yellow-600 dark-border-yellow-600 px-6 py-3 rounded-2xl border text-2xl">+ Add Experience</button>
      <div className="mt-8">
          {onSaveChanges && (
            <button 
