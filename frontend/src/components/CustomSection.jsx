...
const CustomSection = ({ data, setData, onSaveChanges, isUpdating, enhancingId, onEnhance, onMobilePreview, isMobile }) => {
  ...
  const handleEnhance = (id, field) => {
    ...
    if (item) {
      onEnhance(id, `custom section ${field}`, item[field], (enhancedText) => {
        setData((prev) =>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    onClick={() => handleEnhance(section.id, "content")}
                    disabled={enhancingId === section.id}
